...
<head>
    ...
    <title>Список квалификаций колледжа</title>
...
<body>
    <div class="main-content">
        <h1>Квалификации колледжа</h1>
        <a href="{{ route('college_qualifications.create') }}" class="btn btn-primary">Добавить</a>
        ...
        <div class="qualifications-grid" style="margin-top: 30px">
            @foreach($qualifications as $qualification)
                <div class="qualification-item">
                    ...
                    <span style="font-size: 18px">({{ $qualification->collegeGlobalSpecialty->name ?? 'Не указано' }})</span><br>

                    <div class="button-group">
                        <!-- Кнопка "Редактировать" -->
                        <a href="{{ route('college_qualifications.edit', $qualification) }}">
                        ...
                        <!-- Кнопка "Удалить" -->
                        <form action="{{ route('college_qualifications.destroy', $qualification) }}" method="POST" class="delete-form">
                            @csrf
                            @method('DELETE')
