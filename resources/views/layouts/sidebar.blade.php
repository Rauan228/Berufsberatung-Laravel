...
<head>
    ...
    <style>
        ...
        .sidebar button, .dropdown .btn-primary {
    margin: 20px 0; /* Увеличенный вертикальный отступ */
}
...
.sidebar .logout-button {
    ...
    font-weight: bold;
    border-radius: 5px;
    transition: background 0.3s ease, transform 0.3s ease; /* Добавил плавное увеличение */
}
    ...
    <p style="font-size: 25px">Admin: {{ $admin->name }}</p> <!-- Выведет имя текущего админа -->
        <a href="{{ route('home') }}">
            <button class="btn btn-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 19 13">
        ...
        <div class="dropdown">
            <button class="btn btn-primary">
                <svg width="16px" height="16px" viewBox="4 -3 19 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="layer1">
                        <path d="M 4 3 L 4 9 L 5 9 L 5 7 L 19 7 L 19 16 L 5 16 L 5 14 L 4 14 L 4 17 L 20 17 L 20 3 L 4 3 z M 5 4 L 19 4 L 19 6 L 5 6 L 5 4 z M 8 8 L 11 11 L 0 11 L 0 12 L 11 12 L 8 15 L 9.5 15 L 13 11.5 L 9.5 8 L 8 8 z" style="fill:#fff; fill-opacity:1; stroke:none; stroke-width:0px; margin: 0 10 0 0;" />
                    </g>
                </svg>
                Applications
        ...
        <a href="{{ route('users.index') }}">
            <button class="btn btn-primary">
                <svg width="16px" height="16px" viewBox="4 -3 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 20V18C13 15.2386 10.7614 13 8 13C5.23858 13 3 15.2386 3 18V20H13ZM13 20H21V19C21 16.0545 18.7614 14 16 14C14.5867 14 13.3103 14.6255 12.4009 15.6311M11 7C11 8.65685 9.65685 10 8 10C6.34315 10 5 8.65685 5 7C5 5.34315 6.34315 4 8 4C9.65685 4 11 5.34315 11 7ZM18 9C18 10.1046 17.1046 11 16 11C14.8954 11 14 10.1046 14 9C14 7.89543 14.8954 7 16 7C17.1046 7 18 7.89543 18 9Z" style="fill:#fff; stroke:none; stroke-width:0px; margin: 0 10 0 0;" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                Users
            </button>
        </a>
        ...
        <a href="{{ url('/events') }}">
            <button class="btn btn-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-event" viewBox="0 0 19 13">
                    <path d="M11 6.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5z" style="fill:#fff; fill-opacity:1; stroke:none; stroke-width:0px; margin: 0 10 0 0;" />
        ...
        <a href="{{ route('reviews.index') }}">
            <button class="btn btn-primary">
                <img width="18" height="20" src="https://img.icons8.com/?size=100&id=463&format=png&color=FFFFFF" alt="Review">
                <span>Reviews</span>
            </button>
        </a>
        ...
        <a href="{{ route('likes.index') }}">
            <button class="btn btn-primary">
                <img width="18" height="20" src="https://img.icons8.com/ios/50/FFFFFF/facebook-like--v1.png" alt="facebook-like--v1" />
                Likes
            </button>
        </a>
        ...
        <a href="{{ route('grants.index') }}">
            <button class="btn btn-primary">
                <img width="21" height="21" src="https://img.icons8.com/external-glyph-silhouettes-icons-papa-vector/50/FFFFFF/external-Scholarship-black-glyph-icon-bonuses.-glyph.-silhouette-glyph-silhouettes-icons-papa-vector.png" alt="external-Scholarship-black-glyph-icon-bonuses.-glyph.-silhouette-glyph-silhouettes-icons-papa-vector" />
                Grants
            </button>
        </a>
        ...
        <button class="logout-button" onclick="document.getElementById('logout-form').submit();">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M10 15a1 1 0 0 1-1-1v-3H5a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4V2a1 1 0 0 1 1.707-.707l5 5a1 1 0 0 1 0 1.414l-5 5A1 1 0 0 1 10 15zm1-6V7H5v2h6zm2-1a.5.5 0 0 0 0-1H5a.5.5 0 0 0 0 1h8z"/>
            </svg>
            Logout
        </button>
